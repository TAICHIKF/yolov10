...
if __name__ == '__main__':
    ...
    model.train(data='ultralytics/cfg/datasets/coco.yaml', epochs=1000, imgsz=640,batch=64, device=[0], name=task_name, cache=True, plots=True)
