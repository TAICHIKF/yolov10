...
WELCOME_SENTENCE = "欢迎使用基于yolov10的COCO目标检测系统"
...
class MainWindow(QTabWidget):
    ...
    def initUI(self):
        ...
        label_super.setText("<a href='https://github.com/TAICHIKF'>作者：TAICHIFEI</a>")
    ...
    def detect_img(self):
        ...
        record_dir = os.path.join(base_dir, "images", "record", "img")
        
        # 确保 images/record/img 目录存在
        if not os.path.exists(record_dir):
            os.makedirs(record_dir)
        cv2.imwrite("images/record/img/{}.jpg".format(time_re), im_record)
        # 保存txt记录文件
    ...
    def check_record(self):
        """打开历史记录文件夹"""
        os.startfile(osp.join(os.path.abspath(os.path.dirname(__file__)), "images/record"))
